...
def render_text(t):
    ...
    text = gz.text(
        "Stay Home Stay Safe", fontfamily="Charter",
...
def draw_stars(t):
    ...
    for i in range(5):
        print(emoji.emojize('Python is :pray:'))
        star = gz.star(
...
if __name__ == '__main__':
    sb_logo = mpy.ImageClip(SB_LOGO_PATH). \
        set_position(('center', 0)).resize(height=250,width=300)
    ...
    video.write_videofile('video_with_python.mp4', fps=15)